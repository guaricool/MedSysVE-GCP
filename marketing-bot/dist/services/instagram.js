...
async function publishToInstagram(imageBuffer, caption, hashtags, accessToken, instagramAccountId) {
    console.log("Uploading image to temporary GCS bucket...");
    const bucketName = process.env.TEMP_BUCKET_NAME || "medsysve-bot-temp";
    const fileName = `ig-post-${(0, crypto_1.randomUUID)()}.png`;
    ...
    try {
        ...
        const containerRes = await axios_1.default.post(`https://graph.facebook.com/v19.0/${instagramAccountId}/media`, {
            image_url: url,
            caption: fullText,
        ...
        const publishRes = await axios_1.default.post(`https://graph.facebook.com/v19.0/${instagramAccountId}/media_publish`, {
