...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await auditFromHeaders("EXPORT_PDF_LAB_ORDER", {
    userId: user.id,
    userRole: user.role,
  ...
  const filename = (omitSello ? "preview-" : "") + pdfFilename("laboratorio", pat.nombre, pat.apellido, new Date(o.createdAt))
