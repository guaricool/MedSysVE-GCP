...
const SPECIALTY_PDF_LABELS: Record<string, string> = {
  ...
  stsScoreMortality: "STS Risk Mortalidad (%)",
  stsScoreMorbidity: "STS Risk Morbilidad (%)",
  nyhaClass: "Clase NYHA",
  ccsClass: "Clase CCS Angina",
  frailtyScore: "Índice de Fragilidad",
  dominanciaCoronaria: "Dominancia Coronaria",
  stenosisTci: "Estenosis TCI (%)",
  stenosisDa: "Estenosis DA (%)",
  stenosisCx: "Estenosis Cx (%)",
  stenosisCd: "Estenosis CD (%)",
  syntaxScore: "Syntax Score",
  fevi: "FEVI (%)",
  gradienteMedioAortico: "Gradiente Medio Aórtico (mmHg)",
  gradientePicoAortico: "Gradiente Pico Aórtico (mmHg)",
  areaValvularAortica: "Área Valvular Aórtica (cm²)",
  areaValvularMitral: "Área Valvular Mitral (cm²)",
  psap: "PSAP (mmHg)",
  derramePericardico: "Derrame Pericárdico",
  diametroAortaAscendente: "Diámetro Aorta Ascendente (mm)",
  diametroArcoAortico: "Diámetro Arco Aórtico (mm)",
  diametroAortaDescendente: "Diámetro Aorta Descendente (mm)",
  diametroAortaAbdominal: "Diámetro Aorta Abdominal (mm)",
  diametroIliofemoral: "Diámetro Acceso Iliofemoral (mm)",
  testAllenDerecho: "Test de Allen (Mano Derecha)",
  testAllenIzquierdo: "Test de Allen (Mano Izquierda)",
  calidadSafena: "Calidad de Vena Safena",
  estabilidadEsternal: "Estabilidad Esternal Posop",
  cicatrizEsternotomia: "Estado Herida / Esternotomía",
  escalaAsepsis: "Score ASEPSIS",
  inrObjetivoMin: "INR Objetivo Mínimo",
  inrObjetivoMax: "INR Objetivo Máximo",
  inrActual: "INR Actual",
  esquemaAnticoagulante: "Esquema de Anticoagulación",
  diasSuspensionAntiagregantes: "Días Suspensión Antiagregantes",
  protocoloTraslapeHeparina: "Protocolo Traslape HBPM",
  procedimientoPropuesto: "Procedimiento Quirúrgico Propuesto",
  tipoCanulacion: "Estrategia de Canulación CEC",
  tipoCardioplejia: "Protección Miocárdica / Cardioplejía",
  gradoHipotermia: "Grado de Hipotermia CEC",
  planCellSaver: "Uso de Cell Saver",
  diaPosoperatorio: "Día Posoperatorio (DPO)",
  usoFajaEsternal: "Uso de Faja / Chaleco Esternal",
  complicacionesPosop: "Complicaciones Posoperatorias",
  indicacionRehabilitacionCardiaca: "Rehabilitación Cardíaca Indicada",
  observacionesQuirurgicas: "Observaciones Quirúrgicas",
  // Cardiología
